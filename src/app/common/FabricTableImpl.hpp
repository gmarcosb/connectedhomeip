...
/// kEndpointID: Tag for the Endpoint ID to which this entry applies to
 ...
 */
template <class StorageId, class StorageData, size_t kPersistentStorageDataBufferMax, size_t kPersistentFabricBufferMax, uint16_t kMaxPerFabric>
struct FabricEntryData : public PersistentData<kPersistentFabricBufferMax>
{
    using Serializer = DefaultSerializer<StorageId, StorageData>;
    using TypedTableEntryData = TableEntryData<StorageId, StorageData, kPersistentStorageDataBufferMax>;
    ...
    /// @brief Finds the index of where to insert current entry by going through the endpoint's table and looking if the entry is
    ...
    /// @brief Removes an entry from the non-volatile memory and clears its index in the entry map. Decreases the number of entries in
    /// the global entry count and in the entry fabric data if successful. As the entry map size is not compressed upon removal,
...
CHIP_ERROR FabricTableImpl<StorageId, StorageData, kIteratorsMax>::Init(PersistentStorageDelegate * storage)
{
    ...
    VerifyOrReturnError(mMaxPerFabric <= Serializer::kMaxPerFabric(),
...
template <class StorageId, class StorageData, size_t kIteratorsMax>
CHIP_ERROR FabricTableImpl<StorageId, StorageData, kIteratorsMax>::GetFabricEntryCount(FabricIndex fabric_index, uint8_t & entry_count)
{
    using Serializer = DefaultSerializer<StorageId, StorageData>;
    using TypedFabricEntryData = FabricEntryData<StorageId, StorageData, Serializer::kPersistentStorageDataBufferMax(), Serializer::kPersistentFabricBufferMax(), Serializer::kMaxPerFabric()>;
...
template <class StorageId, class StorageData, size_t kIteratorsMax>
CHIP_ERROR FabricTableImpl<StorageId, StorageData, kIteratorsMax>::GetRemainingCapacity(FabricIndex fabric_index, uint8_t & capacity)
{
    using Serializer = DefaultSerializer<StorageId, StorageData>;
    using TypedFabricEntryData = FabricEntryData<StorageId, StorageData, Serializer::kPersistentStorageDataBufferMax(), Serializer::kPersistentFabricBufferMax(), Serializer::kMaxPerFabric()>;
...
template <class StorageId, class StorageData, size_t kIteratorsMax>
CHIP_ERROR FabricTableImpl<StorageId, StorageData, kIteratorsMax>::GetTableEntry(FabricIndex fabric_index, StorageId entry_id, TableEntry & entry)
{
    using Serializer = DefaultSerializer<StorageId, StorageData>;
    using TypedFabricEntryData = FabricEntryData<StorageId, StorageData, Serializer::kPersistentStorageDataBufferMax(), Serializer::kPersistentFabricBufferMax(), Serializer::kMaxPerFabric()>;
    using TypedTableEntryData = TableEntryData<StorageId, StorageData, Serializer::kPersistentStorageDataBufferMax()>;
    ...
    // kPersistentStorageDataBufferMax was reduced by OTA) and therefore must be deleted as is is no longer considered accessible.
...
template <class StorageId, class StorageData, size_t kIteratorsMax>
CHIP_ERROR FabricTableImpl<StorageId, StorageData, kIteratorsMax>::RemoveTableEntryAtPosition(EndpointId endpoint, FabricIndex fabric_index,
...
CHIP_ERROR FabricTableImpl<StorageId, StorageData, kIteratorsMax>::RemoveFabric(FabricIndex fabric_index)
{
    ...
    for (auto endpoint : app::EnabledEndpointsWithServerCluster(kEntryEndpointClusterID()))
    {
...
template <class StorageId, class StorageData, size_t kIteratorsMax>
uint8_t FabricTableImpl<StorageId, StorageData, kIteratorsMax>::GetClustersFromEndpoint(ClusterId * clusterList, uint8_t listLen)
{
...
/// files
template <class StorageId, class StorageData, size_t kIteratorsMax>
uint8_t FabricTableImpl<StorageId, StorageData, kIteratorsMax>::GetClusterCountFromEndpoint()
{
...
template <class StorageId, class StorageData, size_t kIteratorsMax>
typename FabricTableImpl<StorageId, StorageData, kIteratorsMax>::EntryIterator * FabricTableImpl<StorageId, StorageData, kIteratorsMax>::IterateTableEntries(FabricIndex fabric)
{
...
template <class StorageId, class StorageData, size_t kIteratorsMax>
FabricTableImpl<StorageId, StorageData, kIteratorsMax>::EntryIteratorImpl::EntryIteratorImpl(FabricTableImpl & provider, FabricIndex fabricIdx,
                                                                      EndpointId endpoint, uint16_t maxPerFabric,
                                                                      uint16_t maxPerEndpoint) :
    mProvider(provider),
