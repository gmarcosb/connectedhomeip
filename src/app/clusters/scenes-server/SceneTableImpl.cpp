...
// Serialize method.
template<>
constexpr size_t Serializer::kPersistentStorageDataBufferMax() { return CHIP_CONFIG_SCENES_MAX_SERIALIZED_SCENE_SIZE_BYTES; }

template<>
constexpr uint16_t Serializer::kMaxPerFabric() { return kMaxScenesPerFabric; }

template<>
constexpr uint16_t Serializer::kMaxPerEndpoint() { return kMaxScenesPerEndpoint; }
...
template<>
constexpr size_t Serializer::kPersistentFabricBufferMax() { return 128; }

template<>
constexpr EndpointId DefaultSceneTableImpl::Super::kEntryEndpointClusterID() { return chip::app::Clusters::ScenesManagement::Id; }

using SceneTableData = TableEntryData<SceneStorageId, SceneData, Serializer::kPersistentStorageDataBufferMax()>;
using FabricSceneData = FabricEntryData<SceneStorageId, SceneData, Serializer::kPersistentStorageDataBufferMax(), Serializer::kPersistentFabricBufferMax(), kMaxScenesPerFabric>;
